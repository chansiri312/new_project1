...
<body>
    ...
    if ($_GET['date'] != '') {
        ...
        $sql = "select * from vaccine  where date = '" . $_GET['date'] . "'";
   ...
   <div class="b"><p5>มกษ. 6408-2552</p5></div>
    ...
    <table>
        <tr>
            <td align="center">
                <font size="+2"><b>แบบบันทึกข้อมูลการใช้วัคซีน และถ่ายพยาธิ (ทั้งฝูง)</b></font>
            </td>
		</tr>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td width="8%" align="left"><font size="+2">&nbsp;<?php echo $result1['name']; ?></font></td>
  ...
  <table height="159" border="1">
        <tr>
            ...
            <td rowspan="2" align="center">
                <font size="+2">คอก/ฝูง</font>
            </td>
			<td  colspan="2" align="center">
                <font size="+2">การใช้วัคซีน</font>
            </td>
			<td colspan="2" align="center">
                <font size="+2">การใช้ยาถ่ายพยาธิ</font>
            </td>
			<td rowspan="2" align="center">
                <font size="+2">การตรวจ<br />โรคบลูเซลโลซีส</font>
            </td>
			<td rowspan="2" align="center">
                <font size="+3">ผู้ปฏิบัติงาน</font>
			</td>
				<td rowspan="2" align="center">
                <font size="+2">ผู้ควบคุม</font>
            </td>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td align="center">
                        <font size="+2"><?php echo $result['stall']; ?></font>
                    </td>
					<td align="center">
						<font size="+2"><?php echo $result['name_vaccine']; ?>
						</font>
				  </td>
					<td align="center">
						<font size="+2"><?php echo $result['num_goat']; ?>
						</font>
				  </td>
					<td align="center">
						<font size="+2"><?php echo $result['name_mediacal']; ?>
						</font>
				  </td>
					<td align="center">
						<font size="+2"><?php echo $result['num_gost1']; ?>
						</font>
				  </td>
					<td align="center">
						<font size="+2"><?php echo $result['examination']; ?>
						</font>
				  </td>
					<td align="center">
						<font size="+2"><?php echo $result['operator']; ?>
						</font>
				  </td>
					<td align="center">
						<font size="+2"><?php echo $result['controller']; ?>
						</font>
				  </td>
