...
<div class="dataMheader">
    ...
    if (isset($_POST["txtKeyword"])) {
        ...
        $sql = "SELECT * FROM vaccine WHERE date LIKE '%" . $strKeyword . "%' ";
                    ...
                    <div class="container">
                        ...
                        <div class="card ">
                            ...
                            <table width="600" border="0">
                                <tr>
                                    <th width="92"> <a href="form_vaccine.php"><button type="submid" class="btn btn-success">เพิ่มข้อมูล</button></a></th>
                                    ...
                                    <th align="rigth">
                                        <font face="cordia new" size="+2">
                                            <a href="pdf_vaccine.php?date=<?php echo $strKeyword; ?>" target="blank">
                                     ...
                                     while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href='form_edit_vaccine.php?editID=<?php echo $row["id"]; ?>'>
                                                    <button type="submit" class="btn btn-secondary btn-block">แก้ไขข้อมูล</button></a>&nbsp;&nbsp;
                                                <a href="JavaScript:if(confirm('Confirm Delete?') == true){window.location='vaccinedb.php?CusID=<?php echo $row["id"]; ?>';}">
