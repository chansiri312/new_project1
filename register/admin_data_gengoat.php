...
<body>
    ...
    <div class="dataMheader">
        ...
        <div class="row">
            <br />
            <div class="col">
                <div class="card-body-data " style="height:100%; background :#9ACFBB">
                    <div class="container">
                        <br />
                        <div class="card ">
                            ...
                            <div class="row">
                                <div class="col">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="admin_add_gengost.php"><button type="submid" class="btn btn-success">เพิ่มข้อมูล</button></a>
                                    &nbsp;&nbsp;
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php while ($row = $result->fetch_assoc()) : ?>
                                        <tr>
                                            <td><?php echo $row['gen_gost']; ?></td>


                                            <td><a href="JavaScript:if(confirm('Confirm Delete?') == true){window.location='admin_gengostdb.php?CusID=<?php echo $row["gen_gost"]; ?>';}">
