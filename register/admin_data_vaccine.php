                    ...
                    <div class="container">
                        ...
                        <div class="card ">
                            <i class="fa fa-align-center" aria-hidden="true">
                                <h1>รายการข้อมูล วัคซีน</h1>
                            </i>
                            <br />
                            <div class="row">
                                <div class="col">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="admin_add_vaccine.php"><button type="submid" class="btn btn-success">เพิ่มข้อมูล</button></a>
                                    &nbsp;&nbsp;
                                ...
                                <tbody>
                                    <?php while ($row = $result->fetch_assoc()) : ?>
                                        <tr>
                                            ...
                                            <td><a href="JavaScript:if(confirm('Confirm Delete?') == true){window.location='admin_vaccinedb.php?CusID=<?php echo $row["vaccine"]; ?>';}">
