      ...
      <div class="card-body" style="width: 380px; height: 110vh ">
        <nav id="navbar-example3" class="navbar navbar-light bg-light flex-column align-items-stretch p-3">
          <nav class="nav nav-pills flex-column">
            ...
            <nav class="nav nav-pills flex-column">
              <a class="nav-link ms-3 my-1" href="data_Management.php">แบบบันทึกข้อมูลทะเบียนประวัติแพะนม</a>
              <a class="nav-link ms-3 my-1" href="data_historyData.php">แบบบันทึกข้อมูลประวัติการให้ผลผลิต(รายฟาร์ม)</a>
            ...
            <a class="nav-link" href="personal_information.php">ข้อมูลฟาร์ม</a>
      </div>
    </div>
    <div class="col-lg-8">
      <div class="container">
