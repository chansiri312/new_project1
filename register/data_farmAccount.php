...
<body>
    ...
    if (isset($_POST["txtKeyword"])) {
        ...
        $sql = "SELECT * FROM farmaccount WHERE birthday LIKE '%" . $strKeyword . "%' ";
                    ...
                    <div class="container">
                        ...
                        <div class="card ">
                            ...
                            <table width="650" border="0">
                                <tr>
                                    <th width="100"> <a href="form_farmAccount.php"><button type="submid" class="btn btn-success">เพิ่มข้อมูล</button></a></th>
                                    ...
                                    <th align="rigth">
                                        <font face="cordia new" size="+2">
                                            <a href="pdf_farmAccount.php?birthday=<?php echo $strKeyword; ?>" target="blank">
                                    ...
                                    while ($result = mysqli_fetch_array($query, MYSQLI_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href='form_edit_farmAccount.php?editID=<?php echo $result["id"]; ?>'>
                                                    <button type="submit" class="btn btn-secondary btn-block">แก้ไขข้อมูล</button></a>&nbsp;&nbsp;
                                                <a href="JavaScript:if(confirm('Confirm Delete?') == true){window.location='farmAccountdb.php?CusID=<?php echo $result["id"]; ?>';}">
