                    ...
                    <div class="container">
                        ...
                        <div class="card ">
                            <i class="fa fa-align-center" aria-hidden="true">
                                <h1>รายการข้อมูล ยาเวชภัณฑ์</h1>
                            </i>
                            <br />
                            <div class="row">
                                <div class="col">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="admin_add_maternal.php"><button type="submid" class="btn btn-success">เพิ่มข้อมูล</button></a>
                                    &nbsp;&nbsp;
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th scope="col">ชื่อยาเวชภัณฑ์</th>
                                ...
                                <tbody>
                                    <?php while ($row = $result->fetch_assoc()) : ?>
                                        <tr>
                                            <td><?php echo $row['medical_supplies']; ?></td>


                                            <td><a href="JavaScript:if(confirm('Confirm Delete?') == true){window.location='admin_maternaldb.php?CusID=<?php echo $row["medical_supplies"]; ?>';}">
